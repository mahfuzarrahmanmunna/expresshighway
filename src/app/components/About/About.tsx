      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="about-content flex flex-col">
            <span className="about-anim text-[10px] uppercase tracking-[0.4em] text-primary/80 font-medium mb-6 block">
              The Express Experience
            </span>

            <h2
              className="about-split-heading font-[family-name:var(--font-playfair)] text-4xl md:text-5xl lg:text-6xl font-medium leading-[1.05] text-foreground mb-10"
            ...
            <p className="about-anim text-sm md:text-base font-light text-foreground/50 leading-relaxed max-w-xl mb-12">
          ...
          <div className="about-anim relative w-full aspect-[4/5] md:aspect-square lg:aspect-[4/5]">
            ...
            {/* Map Wrapper */}
            <div className="map-wrapper relative w-full h-full overflow-hidden border border-white/[0.05]">
              {/* CSS Filtered Dark Google Map */}
              <iframe
                ...
                className="map-iframe absolute inset-[-10%] w-[120%] h-[120%] grayscale invert contrast-[0.9] brightness-[0.85] opacity-90"
                style={{ border: 0 }}
                loading="lazy"
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#050505]/40 via-transparent to-transparent" />
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
                ...
                <div className="mt-6 bg-black/60 backdrop-blur-md border border-white/[0.05] px-5 py-4 flex items-center gap-3 shadow-2xl">
