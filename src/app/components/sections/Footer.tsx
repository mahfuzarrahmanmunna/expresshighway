  ...
  return (
    <div className="mt-10">
      ...
      <div className="flex items-center gap-0">
        ...
        <button
          type="button"
          className="flex h-10 w-10 shrink-0 items-center justify-center border-none bg-transparent cursor-pointer text-foreground/20 transition-all duration-[400ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:text-primary hover:translate-x-1"
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#050608] overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-primary/[0.03] blur-[180px] rounded-full" />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 pt-24 pb-12">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[8px] font-mono tracking-[0.3em] uppercase text-foreground/20">
                Expressway — KM 42
              </span>
            </div>
            ...
            <div className="hidden items-center gap-3 sm:flex">
              <span className="text-[8px] font-mono tracking-[0.2em] text-foreground/20">
                22°27&apos;N
              </span>
      ...
      <div ref={logoRef} className={cn("relative z-10 mx-auto max-w-7xl px-6 lg:px-8 pb-20", !isReducedMotion && "opacity-0")}>
        <h2 className="font-[family-name:var(--font-playfair)] text-[clamp(3rem,12vw,11rem)] leading-[0.85] font-medium tracking-tight select-none bg-gradient-to-b from-white/90 via-white/40 to-white/10 bg-clip-text text-transparent">
          Express<br/>
          <span className="italic text-primary/60">Highway Inn.</span>
        </h2>
      </div>
      ...
      <div ref={mainRef} className={cn("relative z-10 mx-auto max-w-7xl px-6 lg:px-8 pb-20", !isReducedMotion && "opacity-0")}>
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-8 xl:gap-12">
          ...
          <div className="lg:col-span-5 xl:col-span-5">
            <p className="text-[13px] leading-[1.8] text-foreground/30 max-w-sm font-light">
          ...
          <div className="lg:col-span-4 xl:col-span-4 grid grid-cols-2 sm:grid-cols-3 gap-8">
            {Object.entries(FOOTER_LINKS).map(([heading, links], colIdx) => (
              <div key={heading}>
                <h4 className="text-[9px] font-medium tracking-[0.3em] uppercase text-foreground/40 pb-4 border-b border-white/[0.08] mb-5 flex items-center gap-2">
                  <span className="text-primary/50">{`0${colIdx + 1}`}</span>
                  {heading}
                </h4>
                  ...
                  {links.map((link) => (
                    <li key={link.label}>
                      <a
                        ...
                        className="group relative inline-flex items-center text-[12px] leading-none text-foreground/40 transition-all duration-[400ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:text-foreground/90 hover:pl-2"
                      >
                        {/* Hover dot indicator */}
          ...
          <div className="lg:col-span-3 xl:col-span-3">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.label}>
                  <p className="text-[8px] tracking-[0.2em] uppercase text-foreground/20 mb-1.5">
                    {item.label}
                  </p>
                  <a 
                    href={item.href}
                    className="text-[13px] text-foreground/50 transition-colors duration-300 hover:text-foreground/80 cursor-pointer font-light block"
                  >
                    {item.value}
                  </a>
                </div>
            ...
            <div className="mt-8 flex items-center gap-3">
              {CONTACT_ICONS.map(({ Icon, label, href }) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.08] text-foreground/25 transition-all duration-[400ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-primary/30 hover:text-primary hover:bg-primary/[0.05] hover:scale-110"
                >
      ...
      <div className="relative z-10 border-t border-white/[0.04]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-6">
          <div className="flex flex-col items-center justify-between gap-5 sm:flex-row">
            {/* Copyright */}
            <p className="text-[9px] tracking-[0.15em] text-foreground/25 font-light">
