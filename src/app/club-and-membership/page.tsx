...
/* 
   Facilities Grid Math (Desktop 12-Col Grid):
...
export default function ClubAndMembershipPage() {
  ...
  useGSAP(
    () => {
      ...
      /* Facilities Cinematic Reveal & Parallax */
      ...
      items.forEach((item) => {
        ...
        /* 
          Dual-wrapper parallax system: 
          Animating the outer wrapper prevents conflicts with CSS hover transforms on the image.
        */
  ...
  return (
    <main ref={containerRef} className="relative w-full bg-[#F7F6F2] text-[#0c0b0b] overflow-x-hidden font-[family-name:var(--font-sans)]">
      ...
      <section className="relative w-full h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-[#080808]">
        ...
        <div className="absolute top-8 left-8 w-6 h-6 border-t border-l border-primary/40 z-20 hidden md:block"></div>
        <div className="absolute top-8 right-8 w-6 h-6 border-t border-r border-primary/40 z-20 hidden md:block"></div>
        <div className="absolute bottom-8 left-8 w-6 h-6 border-b border-l border-primary/40 z-20 hidden md:block"></div>
        <div className="absolute bottom-8 right-8 w-6 h-6 border-b border-r border-primary/40 z-20 hidden md:block"></div>
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="cm-hero-head font-[family-name:var(--font-playfair)] text-[clamp(3.5rem,10vw,9rem)] font-light leading-[1.05] tracking-[-0.03em] text-white mb-12">
            Club & <span className="italic text-primary">Membership.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-10">
            ...
            <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl lg:text-6xl font-light leading-[1.05] text-[#0c0b0b] mb-8 tracking-[-0.02em]">
              Beyond a <br/>
              <span className="italic text-primary">Stop.</span>
            </h2>
          ...
          <div className="lg:col-span-7 vp-grid flex flex-col gap-px bg-[#0c0b0b]/10 border border-[#0c0b0b]/10">
            {[
              ...
              <div key={item.num} className="vp-card group relative bg-[#F7F6F2] p-8 md:p-10 flex flex-col md:flex-row gap-8 transition-colors duration-500 hover:bg-white overflow-hidden">
                ...
                <span className="absolute top-0 left-0 right-0 h-[2px] bg-primary scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]"></span>
                
                <span className="font-[family-name:var(--font-playfair)] text-3xl text-[#0c0b0b]/20 transition-colors duration-500 group-hover:text-primary">
                  {item.num}
                </span>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-20 md:mb-24">
            ...
            <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-6xl lg:text-7xl font-light leading-[1.05] tracking-[-0.02em] max-w-4xl">
              Membership <span className="italic text-primary">Tiers.</span>
            </h2>
          ...
          <div className="tiers-grid grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {MEMBERSHIP_TIERS.map((tier) => (
              ...
              >
                {/* Architectural Corners for Highlight */}
                {tier.highlight && (
                  <>
                    <div className="absolute top-4 left-4 w-6 h-6 border-t border-l border-primary z-10"></div>
                    <div className="absolute top-4 right-4 w-6 h-6 border-t border-r border-primary z-10"></div>
                    <div className="absolute bottom-4 left-4 w-6 h-6 border-b border-l border-primary z-10"></div>
                    <div className="absolute bottom-4 right-4 w-6 h-6 border-b border-r border-primary z-10"></div>
                  </>
                )}
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 mb-20 md:mb-24">
          <div className="max-w-4xl">
            ...
            <h2 className="font-[family-name:var(--font-playfair)] text-[clamp(3rem,7vw,6rem)] font-light leading-[0.85] tracking-tight text-[#0c0b0b]">
              Curated <br/>
              <span className="italic text-primary">Spaces.</span>
            </h2>
          </div>
      ...
      <section className="relative w-full bg-[#080808] text-white py-24 md:py-32 overflow-hidden z-10">
        ...
        <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
          ...
          <a 
            href="/contactus" 
            className="group relative inline-flex items-center justify-center gap-4 px-10 py-5 bg-primary text-[#0c0b0b] text-[10px] uppercase tracking-[0.35em] font-bold overflow-hidden cursor-pointer hover:bg-white transition-colors duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
          >
